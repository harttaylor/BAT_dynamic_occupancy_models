################################################################################
# 02b_fit_models_BCAK.R — BC + Alaska Dynamic Occupancy Models (all species)
#
# Loops through all species and fits each one.
# No dist_harvest (unavailable for Alaska). JAGS names the scalar
# distance params "beta.gamma" and "beta.phi" (no [1] index).
#
...
cat("\n\nAll BCAK models complete. Output:", OUTPUT_DIR, "\n")
